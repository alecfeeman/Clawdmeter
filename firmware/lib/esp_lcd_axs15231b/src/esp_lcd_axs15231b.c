...
#include "esp_log.h"
#include "esp_check.h"
/* touch driver omitted — esp_lcd_touch.h's old uint32_t I2C bus signature
 * conflicts with arduino-esp32 framework's i2c_master_bus_handle_t API.
 * We'll add touch later as a small custom driver. */
...
/* touch fwd-decls removed (touch driver omitted in this vendor copy) */

/* i2c helpers for touch removed (touch driver omitted) */
